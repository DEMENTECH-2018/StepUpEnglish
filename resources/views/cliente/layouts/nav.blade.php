<nav class="navbar navbar-default navbar-fixed-top" style="background-color: rgb(77,99,111); padding-top: 0px;">
        <div class="container-fluid">
          ...
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#" style="background-color: rgb(58,75,83); color: #fff;"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>  Brand</a>
          </div>
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" style="color: #fff;">
                    <span class="icon-bell"></span></span></a>
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><img src="{{asset(Auth::user()->avatar)}}" style="height:23px;width:23px" class="img-responsive"></a>
                <ul class="dropdown-menu">
                  <li><a href="#">Action</a></li>
                  <li><a href="#">Another action</a></li>
                  <li><a href="#">Something else here</a></li>
                  ...
                  <li>
                    <a class="dropdown-item" href="{{ route('logout') }}"
                      ...
                      document.getElementById('logout-form').submit();"><span class="icon-exit"></span> 
                      {{ __('Salir') }}
                    </a>
